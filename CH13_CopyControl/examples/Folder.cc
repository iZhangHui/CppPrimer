...
{
	std::cout << "HenryDbg::Folder move constructor." << std::endl;
...
{
	std::cout << "HenryDbg::Message move constructor." << std::endl;
...
{
	std::cout << "HenryDbg::Message copy constructor." << std::endl;
...
{
	std::cout << "HenryDbg::Folder copy constructor." << std::endl;
